...
#### US-004 状態別UI（読み込み/空/エラー）の明確化（P1）
...
#### US-012 比較ビュー（同一group_key/イベント比較）（P1）
